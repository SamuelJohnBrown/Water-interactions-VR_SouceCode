...
namespace HiggsPluginAPI
{
    ...
    IHiggsInterface001* GetHiggsInterface001(const SKSE::PluginHandle& pluginHandle, SKSE::MessagingInterface* messagingInterface);
    ...
    // Declare the global interface pointer inside the namespace
    extern IHiggsInterface001* g_higgsInterface;
}
